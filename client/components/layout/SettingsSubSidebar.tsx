...
import { Shield, Settings, Database, Palette, ChevronLeft } from 'lucide-react';
...
const settingsItems = [
  ...
  { icon: Settings, label: 'System', href: '/settings/system' },
            ...
            <div className="flex-1 overflow-y-auto p-4">
              ...
              <nav className="space-y-0.5">
                {settingsItems.map((item) => {
                  ...
                  const isActive = pathname === item.href || (pathname === '/settings' && item.href === '/settings/privacy');
