      ...
      <CardContent className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4 p-3 sm:p-4 bg-page rounded-lg">
          <div className="flex-1">
            <Label htmlFor="camera-access" className="text-default font-medium">Camera Access</Label>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4 p-3 sm:p-4 bg-page rounded-lg">
          <div className="flex-1">
            <Label htmlFor="microphone-access" className="text-default font-medium">Microphone Access</Label>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4 p-3 sm:p-4 bg-page rounded-lg">
          <div className="flex-1">
            <Label htmlFor="notifications" className="text-default font-medium">Notifications</Label>
