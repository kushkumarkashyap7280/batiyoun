  ...
  const featureList = [
    {
      ...
      title: 'Global Reach',
      description:
        'Connect with anyone, anywhere in the world instantly with our low-latency infrastructure.',
    },
    {
      icon: <Lock className={styles.icon} size={24} />,
      title: 'End-to-End Security',
      description:
        'Your conversations are protected with industry-leading encryption. Privacy is our priority.',
    },
    {
      icon: <Zap className={styles.icon} size={24} />,
      title: 'Lightning Fast',
      description:
        'Powered by Socket.io, Batiyoun delivers messages in milliseconds without refreshing.',
    },
    {
